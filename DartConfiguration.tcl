...
SourceDirectory: /Volumes/T7/git/opencv4cvml
BuildDirectory: /Volumes/T7/git/opencv4cvml
...
MakeCommand: /opt/homebrew/Cellar/cmake/3.24.1/bin/cmake --build . --config "${CTEST_CONFIGURATION_TYPE}" -- -i
